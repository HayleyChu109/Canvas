...
filter = () => {
    contextReal.canvas.style.filter = `blur(${blur_value}px) brightness(${brightness_value}%) contrast(${contrast_value}%) grayscale(${grayscale_value}%) opacity(${opacity_value}%)`
}
